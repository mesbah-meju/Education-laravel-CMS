        ...
        <div class="card border-0 shadow-sm rounded">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center py-3">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h6 class="mb-0 fw-bold">Designation</h6>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('designation.store') }}" method="POST">
                            ...
                            <div class="border-0 mb-4">
                                <h6 class="text-muted fw-semibold" id="addNoticeModalLabel">Add New designation</h6>
                            </div>
                            <div class="mb-3">
                                ...
                                <tbody class="small text-muted">
                                    @foreach($designations as $designation)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <!-- Edit button -->
                                                <button type="button" class="btn btn-soft-primary btn-sm rounded-2"
                                                    data-bs-toggle="modal" data-bs-target="#editDesignationModal"
                                                    data-action="{{ route('designation.update', $designation->id) }}"
                                                    data-name="{{ $designation->name }}" title="Edit">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            $('#editDesignationModal').on('show.bs.modal', function (event) {
