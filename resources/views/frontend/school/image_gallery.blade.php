            ...
            <div class="row g-3">
                @foreach($galleries as $image)
                    <div class="col-6 col-md-4 col-lg-3 text-center">
                        <img src="{{ asset($image->file_path) }}" alt="{{ $image->title }}"
                            class="img-fluid rounded shadow-sm gallery-thumb mb-2"
                            style="cursor:pointer; height: 200px; object-fit: cover; width: 100%;" data-bs-toggle="modal"
                            data-bs-target="#imageModal" data-src="{{ asset($image->file_path) }}">
    ...
    <div class="modal fade" id="imageModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content bg-transparent border-0 p-0 position-relative">
                <img src="" id="modalImage" class="img-fluid rounded-3 shadow mx-auto d-block"
                    style="max-height: 80vh; width: 100%; object-fit: contain;">
                <button type="button" class="btn-close btn-close-dark bg-white position-absolute top-0 end-0 m-3"
